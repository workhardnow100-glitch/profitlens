...
const balanceSheetPrior = {
  ...
  netAssets: overviewPrior?.categories?.equity ?? overviewPrior?.totals?.total_equity ?? 0,   // ✅ builder equity
  capitalAndReserves: overviewPrior?.categories?.equity ?? overviewPrior?.totals?.total_equity ?? 0,   // ✅ builder equity
};
