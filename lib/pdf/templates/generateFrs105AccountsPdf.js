...
const rows = [
  [
    "Fixed assets",
    overview?.categories?.fixedAssets ?? 0,   // ✅ NBV direct
  ...
  [
    ...
    overview?.categories?.equity ?? overview?.totals?.total_equity ?? 0,   // ✅ use builder equity
...
const closingNBV = overview?.categories?.fixedAssets ?? 0;   // ✅ NBV direct from builder
