...
const balanceSheetCurrent = {
  // ✅ NBV for the balance sheet line
  fixedAssets: overview?.categories?.fixedAssets ?? 0,   // ✅ NBV
  ...
  // ✅ Total assets less current liabilities = NBV + net current assets
...
const rows = [
  ["Fixed assets",
    overview?.categories?.fixedAssets ?? 0,   // ✅ NBV, not totals.non_current_assets
  ...
  // ✅ Net assets should equal equity, not recomputed from NBV + current assets
  ["Net assets",
