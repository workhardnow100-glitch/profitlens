...
export async function generateFrs105AccountsPdf({
 ...
 const balanceSheetCurrent = {
  ...
  netAssets: (overviewPrior?.totals?.total_assets ?? 0) - (overviewPrior?.totals?.total_liabilities ?? 0),
  capitalAndReserves: overviewPrior?.totals?.total_equity ?? 0,   // ✅ use locked equity from builder
};
