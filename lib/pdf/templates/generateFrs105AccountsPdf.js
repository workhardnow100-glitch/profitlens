...
export async function generateFrs105AccountsPdf({
  ...
  const balanceSheetPrior = {
    currentAssets: overviewPrior?.balance_sheet_summary?.current_assets ?? "",
    creditors: overviewPrior?.balance_sheet_summary?.current_liabilities ?? "",
    netCurrentAssets: overviewPrior?.balance_sheet_summary?.net_assets ?? "",
    totalAssetsLessLiabilities: overviewPrior?.balance_sheet_summary?.total_assets_less_current_liabilities ?? "",
    totalNetAssets: overviewPrior?.balance_sheet_summary?.net_assets ?? "",
    capitalAndReserves: overviewPrior?.balance_sheet_summary?.equity ?? "",
  };
