...
const balanceSheetCurrent = {
  fixedAssets: (overview?.categories?.fixedAssets ?? 0) - (overview?.categories?.accumulatedDepreciation ?? 0),
  ...
  totalAssetsLessLiabilities: ((overview?.categories?.fixedAssets ?? 0) - (overview?.categories?.accumulatedDepreciation ?? 0))
...
const balanceSheetPrior = {
  fixedAssets: (overviewPrior?.categories?.fixedAssets ?? 0) - (overviewPrior?.categories?.accumulatedDepreciation ?? 0),
  ...
  totalAssetsLessLiabilities: ((overviewPrior?.categories?.fixedAssets ?? 0) - (overviewPrior?.categories?.accumulatedDepreciation ?? 0))
  ...
  const buffer = await createPdfBuffer((doc) => {
    ...
    doc.text(`Opening balance as at 01 January ${currentYear}: £${(overviewPrior?.categories?.fixedAssets ?? 0) - (overviewPrior?.categories?.accumulatedDepreciation ?? 0)}`);
