...
const balanceSheetCurrent = {
  fixedAssets: overview?.categories?.fixedAssets ?? 0,   // NBV direct from builder
...
const balanceSheetPrior = {
  fixedAssets: overviewPrior?.categories?.fixedAssets ?? 0,   // NBV direct from builder
  ...
  ["Fixed assets",
    ...
    overviewPrior?.categories?.fixedAssets ?? 0   // NBV direct
  ],
  ["Current assets",
