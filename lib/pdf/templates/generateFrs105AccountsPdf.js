...
const balanceSheetCurrent = {
  ...
  netAssets: overview?.categories?.equity ?? overview?.totals?.total_equity ?? 0,   // ✅ builder equity
  capitalAndReserves: overview?.categories?.equity ?? overview?.totals?.total_equity ?? 0,   // ✅ builder equity
};
