...
const bgPath = path.join(process.cwd(), "lib/pdf/assets/growth-bg.jpg");

console.log("Logo exists:", fs.existsSync(logoPath)); console.log("BG exists:", fs.existsSync(bgPath)); console.log("Logo path:", logoPath); console.log("BG path:", bgPath);
